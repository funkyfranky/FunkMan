...
class FunkPlot:
    def __init__(self, ImagePath="./funkpics/") -> None:
        ...
        # Info message.
        log.info(f"Init FunkPlot: Reading images from {ImagePath}...")
    ...
    def _GetAoA(self, actype: str):
        ...
        if actype == AircraftType.HARRIER.value:
            ...
            log.warn("WARNING: Unknown aircraft type! Taking generic AoA values")
            return 5, 10, 15
    ...
    def PlotBombRun(self, result):
        ...
        plt.imshow(
            ...
            interpolation="none",
            origin="upper",
            extent=[north - 30, north + 30, north - 23, north + 37],
            clip_on=True,
            zorder=17,
        )
        ...
        plt.imshow(
            ...
            interpolation="none",
            origin="upper",
            extent=[x - scrater, x + scrater, y - scrater, y + scrater],
            clip_on=True,
        )
        ...
        offsetbox = TextArea(
            f'{_GetVal(result, "airframe", "Unknown AC")}\nh={attackAlt} ft\n$v$={attackVel} kts\n$\psi$={attackHdg}°',
    ...
    def PlotStrafeRun(self, result):
        ...
        # Debug info.
        log.debug(f"Plotting Strafe Run for player {player}!")
        ...
        for _ in range(1):  # (roundsHit):
            ...
            plt.imshow(
                ...
                interpolation="none",
                origin="upper",
                extent=[x - bullet, x + bullet, y - bullet, y + bullet],
                clip_on=True,
            )
    ...
    def PlotTrapSheet(self, result, filename=None):
        ...
        try:
            ...
            log.error("ERROR: Trap sheet data does not exist!")
            return
        ...
        if lts == 0:
            log.error("ERROR: Trap sheet is empty!")
            return
